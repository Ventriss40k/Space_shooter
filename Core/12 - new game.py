...
class SmokeParticle(pygame.sprite.Sprite):
    def __init__(self, pos, color = pygame.color.Color("gray64"), speed_x = 0, speed_y=0):
        pygame.sprite.Sprite.__init__(self)
        self.pos = Vector2(pos)
        self.vel = Vector2(random.uniform(-0.5+speed_x, 0.5+speed_x), random.uniform(-0.5 + speed_y, 0.5 + speed_y))
...
class Asteroid(pygame.sprite.Sprite):
    def __init__(self, spawn_distance = 0, x =screen_width+150, y=0 ):
        pygame.sprite.Sprite.__init__(self)
        self.scale = randint(1,7)
        self.image_n = randint(1, 5)
        self.image = pygame.image.load(fr"sprites\asteroid\asteroid-{self.image_n}.png").convert_alpha()
        ...
        self.mask = pygame.mask.from_surface(self.image)
        self.rotation_period = randint(int(self.scale/2), int(self.scale/1.5))
...
class Torpedo(pygame.sprite.Sprite):
    def __init__(self, x ,y, speed_x, speed_y, damage, target):
        ...
        self.images = [pygame.image.load(r"sprites\enemies\Projectiles\Rocket_autopilot\rocket_enemy_autopilot_1.png"),
                       pygame.image.load(r"sprites\enemies\Projectiles\Rocket_autopilot\rocket_enemy_autopilot_2.png"),
                       pygame.image.load(r"sprites\enemies\Projectiles\Rocket_autopilot\rocket_enemy_autopilot_3.png"),
                       pygame.image.load(r"sprites\enemies\Projectiles\Rocket_autopilot\rocket_enemy_autopilot_4.png")]
...
def hazard_gen():
    ...
    for i in range(level.level_lenght//distance_span):
