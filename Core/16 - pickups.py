...
class Bonus(pygame.sprite.Sprite):
    def __init__(self, pos, speed_xy, type= "bonus", image = pygame.image.load(r"sprites\bonus.png").convert_alpha()):
        ...
        self.pos = list(pos)
        self.rect.center = self.pos
        self.speed_xy = list(speed_xy)
        
    def update(self):
        self.pos[0] += self.speed_xy[0]
        self.pos[1] += self.speed_xy[1]
        self.rect.center = self.pos
...
# damage
    def explode(self):
        explosions_group.add(Explosion(self.rect.centerx, self.rect.centery, diameter= self.rect.width))
        self.kill()
