...
class Player(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.spawned_arrived and not self.disengaging:
            smoke_particles_group.add(SmokeParticle([self.rect.left + 5, self.rect.centery], color = pygame.Color('darkslategray1'), speed_x= -self.speed, speed_y = self.vel_y, deviation_y =0, lifetime=10, size_multiplyer=0.8, minsize=7, maxsize=7))
    def spawn(self):
