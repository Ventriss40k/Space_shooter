...
class Asteroid(pygame.sprite.Sprite):
    def __init__(self, spawn_distance = 0, x =screen_width+150, y=0, scale_min = 0.2, scale_max= 1, scale = "random"):
        pygame.sprite.Sprite.__init__(self)
        if scale == "random":
        ...
        original_image = Image.open(fr"sprites\asteroid\asteroids_plan_1 (300х300)\asteroid_plan1_{self.image_n}.png")
